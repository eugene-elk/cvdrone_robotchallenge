...
// --------------------------------------------------------------------------
//! @brief Stop AR.Drone movement
//! @return None
// --------------------------------------------------------------------------

void ARDrone::stop()
{
	move3D(0.0, 0.0, 0.0, 0.0);
}

void ARDrone::smart_move(int dx, int dy)
{
	double kdx = (double(dx) / 50) / 3;
	double kdy = (double(dy) / 50) / 3;
	move3D(kdx, kdy, 0.0, 0.0);
}
