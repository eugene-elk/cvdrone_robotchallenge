...
#define ARDRONE_DEFAULT_ADDR        "192.168.1.144" 
...
public:
	...
	virtual void update_velocity(double& vx, double& vy);
	...
	virtual void stop(); //my func
	virtual void smart_move(int dx, int dy); //my func
